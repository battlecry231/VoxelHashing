...
public:
	...
	static BackbufferToPPM(IDirect3DDevice9*pDevice, const char *zFileName);
	static SurfaceToPPM(IDirect3DDevice9*pDevice, IDirect3DSurface9 *pSurface, const char *zFileName);
